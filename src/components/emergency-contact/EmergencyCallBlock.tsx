...
import { EmergencyCallProps } from './emergency-call-block';

export const EmergencyCallBlock: React.FC<EmergencyCallProps> = ({
  text,
  phoneNumber,
}) => {
  return (
    <div className="shadow-lg rounded-xl w-60 h-16 flex items-center flex-row justify-between px-3 py-1">
