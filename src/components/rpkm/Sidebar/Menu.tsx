  ...
  return (
    <div className='w-full h-full text-left text-[1.88vh] font-medium flex flex-col pb-[5vh]'>
            ...
            <div className='w-full -px-2'>
                <Accordion selectionMode='multiple' className='text-start self-start px-0'>
                <AccordionItem key="1" aria-label="Accordion 1" title="กิจกรรม">
                ...
                <AccordionItem key="2" aria-label="Accordion 2" title="แผนที่">
                    <div className='flex flex-col w-full justify-items-start text-[1.41vh] px-[1.41vh]'>
