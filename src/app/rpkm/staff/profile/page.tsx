...
function Page() {
  ...
  return (
    <div className="flex flex-row justify-items-center justify-center w-full h-screen py-6 px-3">
      <div className="[clip-path:polygon(1rem_0,calc(100%-1rem)_0,100%_1rem,100%_calc(100%-1rem),calc(100%-1rem)_100%,1rem_100%,0_calc(100%-1rem),0_1rem)] flex flex-col justify-items-center items-center bg-[#FFFEF7E5] w-full gap-y-10 pb-20">
        <div
